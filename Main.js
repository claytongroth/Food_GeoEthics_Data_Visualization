...
function setMap(){   
    ...
    d3.csv("/Food_GeoEthics_Data_Visualization/data/nu3Food_EmissionsData2.csv").then(function(data) {
    d3.csv("/Food_GeoEthics_Data_Visualization/data/sums.csv").then(function(data3) {
    d3.json("/Food_GeoEthics_Data_Visualization/data/a.topojson").then(function(data2) {
